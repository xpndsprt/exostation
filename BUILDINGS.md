...
| Bot Bay | `bay` | Houses **one mining drone**. Select it → **🛰 Star Chart** opens an orbital map; dispatch the drone to an asteroid/planet (off-map). It surveys + hauls **minerals** back over a round trip (~25–70s by distance), looping until the body depletes. | 4 | 2×2 | 120 | **Robotics** (¢150) | drone ready / out mining / returning |
