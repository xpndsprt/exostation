...
| Lighting | the interior is **dark & moody** (cool ambient); powered **Light Fixtures** (¢30) and glowing modules throw **soft warm pools** that **cast real shadows** (walls/large modules block light). Crew carry a **moving lamp** (~4 cells). Each room's ambient is **tinted by its gas** (O₂ a bit blue · CH₄ reddish · Cl₂ green · NH₃ indigo · H₂ magenta · mixed danger-red); open space outside stays untinted. Visual only — no gameplay effect |
